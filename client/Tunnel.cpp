 ...
 * @LastEditTime: 2022-07-19 20:03:57
 * @FilePath: /MyCProxy/client/Tunnel.cpp
 * @Descripttion: 
 */
...
SP_ProxyConn Tunnel::createProxyConn(u_int32_t proxy_port) {
    ...
    proxyConn->setCloseLocalPeerConnHandler_(
        std::bind(&Tunnel::shutdownLocalConn, this, std::placeholders::_1)
    );
...
void Tunnel::shutdownLocalConn(SP_ProxyConn proxyConn) {
